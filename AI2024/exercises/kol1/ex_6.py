...
class Squares(Problem):
    ...
    def get_actions(self):
        return [f"Pomesti kvadratche {i} {direction}" for i in range(1, 6) for direction in ["gore", "dolu", "levo", "desno"]]
...
if __name__ == '__main__':
    ...
    # stt = squares.result(initial_state, "Pomesti kvadratche 1 gore")
    # print(stt)
    # print(squares.successor(stt))
